...
void swd_tx(const unsigned char * pBuf,unsigned long bit_len) {
  ...
  for (i = 0; i < bit_len; i ++) {
    ...
    if (((pBuf[i >> 3] >> (i & 7)) & 1) != 0) {
	  __set_swd_io_to_high();
    } else {
	  __set_swd_io_to_low();
	}
	__set_swd_clk_to_high();
	SWD_DELAY;
...
void swd_tx8(const unsigned char * pBuf) {
  ...
  __set_swd_cycle(((*pBuf >> 0)& 0x1));
  __set_swd_cycle(((*pBuf >> 1) & 0x1));
  __set_swd_cycle(((*pBuf >> 2) & 0x1));
  __set_swd_cycle(((*pBuf >> 3) & 0x1));
  __set_swd_cycle(((*pBuf >> 4) & 0x1));
  __set_swd_cycle(((*pBuf >> 5) & 0x1));
  __set_swd_cycle(((*pBuf >> 6) & 0x1));
  __set_swd_cycle(((*pBuf >> 7) & 0x1));
...
void swd_tx32(const unsigned long * pBuf) {
  ...
  __set_swd_cycle(((*pBuf >> 6) & 0x1));
  __set_swd_cycle(((*pBuf >> 7) & 0x1));
  __set_swd_cycle(((*pBuf >> 8) & 0x1));
  __set_swd_cycle(((*pBuf >> 9) & 0x1));
  __set_swd_cycle(((*pBuf >> 10) & 0x1));
  __set_swd_cycle(((*pBuf >> 11) & 0x1));
  __set_swd_cycle(((*pBuf >> 12) & 0x1));
  __set_swd_cycle(((*pBuf >> 13) & 0x1));
  __set_swd_cycle(((*pBuf >> 14) & 0x1));
  __set_swd_cycle(((*pBuf >> 15) & 0x1));
  __set_swd_cycle(((*pBuf >> 16) & 0x1));
  __set_swd_cycle(((*pBuf >> 17) & 0x1));
  __set_swd_cycle(((*pBuf >> 18) & 0x1));
  __set_swd_cycle(((*pBuf >> 19) & 0x1));
  __set_swd_cycle(((*pBuf >> 20) & 0x1));
  __set_swd_cycle(((*pBuf >> 21) & 0x1));
  __set_swd_cycle(((*pBuf >> 22) & 0x1));
  __set_swd_cycle(((*pBuf >> 23) & 0x1));
  __set_swd_cycle(((*pBuf >> 24) & 0x1));
  __set_swd_cycle(((*pBuf >> 25) & 0x1));
  __set_swd_cycle(((*pBuf >> 26) & 0x1));
  __set_swd_cycle(((*pBuf >> 27) & 0x1));
  __set_swd_cycle(((*pBuf >> 28) & 0x1));
  __set_swd_cycle(((*pBuf >> 29) & 0x1));
  __set_swd_cycle(((*pBuf >> 30) & 0x1));
  __set_swd_cycle(((*pBuf >> 31) & 0x1));
...
void swd_rx(unsigned char * pBuf,unsigned long bit_len) {
  ...
  for (i = 0; i < bit_len; i ++) {
	...
	pBuf[i >> 3] |= (__get_swd_io() & 1) << (i & 7);
	__nop();__nop();__nop();__nop();
  }
  __swd_idle();
}

#define __get_swd_cycle(a, b)   {\
	                  __set_swd_clk_to_high();\
	                  SWD_DELAY;\
	                  __set_swd_clk_to_low();\
                     a |= (__get_swd_io() << b);\
...
void swd_rx8(unsigned char * pBuf) {
  ...
  *pBuf = 0;
  ...
  __get_swd_cycle(*pBuf, 0);
  __get_swd_cycle(*pBuf, 1);
  __get_swd_cycle(*pBuf, 2);
  __get_swd_cycle(*pBuf, 3);
  __get_swd_cycle(*pBuf, 4);
  __get_swd_cycle(*pBuf, 5);
  __get_swd_cycle(*pBuf, 6);
  __get_swd_cycle(*pBuf, 7);	
...
void swd_rx32(unsigned long * pBuf) {
  ...
  *pBuf = 0;
  ...
  __get_swd_cycle(*pBuf, 6);
  __get_swd_cycle(*pBuf, 7);	
  __get_swd_cycle(*pBuf, 8);	
  __get_swd_cycle(*pBuf, 9);	
  __get_swd_cycle(*pBuf, 10);
  __get_swd_cycle(*pBuf, 11);
  __get_swd_cycle(*pBuf, 12);
  __get_swd_cycle(*pBuf, 13);
  __get_swd_cycle(*pBuf, 14);
  __get_swd_cycle(*pBuf, 15);
  __get_swd_cycle(*pBuf, 16);
  __get_swd_cycle(*pBuf, 17);	
  __get_swd_cycle(*pBuf, 18);	
  __get_swd_cycle(*pBuf, 19);	
  __get_swd_cycle(*pBuf, 20);
  __get_swd_cycle(*pBuf, 21);
  __get_swd_cycle(*pBuf, 22);
  __get_swd_cycle(*pBuf, 23);
  __get_swd_cycle(*pBuf, 24);
  __get_swd_cycle(*pBuf, 25);
  __get_swd_cycle(*pBuf, 26);
  __get_swd_cycle(*pBuf, 27);	
  __get_swd_cycle(*pBuf, 28);	
  __get_swd_cycle(*pBuf, 29);	
  __get_swd_cycle(*pBuf, 30);
  __get_swd_cycle(*pBuf, 31);
