...
typedef struct {
  ...
  __IO uint32_t CHIP_SEL;            /* offset = 0x64   */
	__IO uint32_t ANA_PWR;
	__IO uint32_t ANA_CLK3;
	__IO uint32_t ANA_SYS;
	__IO uint32_t DIE_VER;
  //__IO uint32_t TRIM_CFG1;               /* offset = 0x70    */
  //__IO uint32_t TRIM_CFG2;               /* offset = 0x74    */
