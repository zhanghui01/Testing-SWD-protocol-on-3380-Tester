...
#ifdef RA9103AM0
  __IO uint32_t CC_CTRL;           /* offset 0x18 cache contrl */
  __IO uint32_t CE;                /* offset 0x1c  ce control */
  __IO uint32_t CC_HIT_LO;         /* offset 0x20 cache hit counter low word */
  __IO uint32_t CC_HIT_HI;         /* offset 0x24 cache hit counter high word */
  __IO uint32_t CC_INST_LO;        /* offset 0x28 cache inst counter low word */
  __IO uint32_t CC_INST_HI;        /* offset 0x2c cache inst counter high word */
  __IO uint32_t CC_ACT_LO;         /* offset 0x30 active inst counter low word */
  __IO uint32_t CC_ACT_HI;         /* offset 0x34 active inst counter hight word */
  __IO uint32_t CC_RUN_LO;         /* offset 0x38 run counter low word */
  __IO uint32_t CC_RUN_HI;         /* offset 0x3c run counter high word */
  __IO uint32_t EP_7M;             /* offset 0x40 user define erase/program time */
  __IO uint32_t EP_3M;             /* offset 0x44 user define erase/program time */
  __IO uint32_t EP_1M;             /* offset 0x48 user define erase/program time */
  __IO uint32_t EP_32K;            /* offset 0x4c user define erase/program time */
#endif
...
typedef struct {
  ...
  __IO uint32_t PROT;              /* offset 0x14  sector protect bit*/
#ifdef RA9103AM0
  __IO uint32_t RESERVED[2];       /* offset 0x18~0x1c reserved */
  __IO uint32_t EP_7M;             /* offset 0x20  user define erase/program time */
  __IO uint32_t EP_3M;             /* offset 0x24  user define erase/program time */
  __IO uint32_t EP_1M;             /* offset 0x28  user define erase/program time */
  __IO uint32_t EP_32K;            /* offset 0x2c  user define erase/program time */
#endif
...
// 	
  ...
  __IO uint32_t RESERVED1[2];            /* offset = 0x38~0x3c */
  __IO uint32_t TEST_CTRL;               /* offset = 0x40    */
  ...
  __IO uint32_t ANA_PWR;                 /* offset = 0x68    */ 
...
typedef struct
{
  ...
  __IO uint32_t SC;              /* 0x04 */    
  __IO uint32_t MN;              /* 0x08 */     
  __IO uint32_t HR;              /* 0x0c */          
  ...
  __IO uint32_t CAL_T0;          /* 0xd0 */
  __IO uint32_t CAL_T1;          /* 0xd4 */
  __IO uint32_t CAL_T2;          /* 0xd8 */
  __IO uint32_t CAL_T3;          /* 0xdc */
  __IO uint32_t CAL_T4;          /* 0xe0 */
  __IO uint32_t CAL_T5;          /* 0xe4 */
  __IO uint32_t CAL_T6;          /* 0xe8 */
  __IO uint32_t CAL_T7;          /* 0xec */
  __IO uint32_t CAL_T8;          /* 0xf0 */
  __IO uint32_t CAL_T9;          /* 0xf4 */
} RTC_TypeDef;
...
typedef struct {
  ...
  __IO uint32_t BUF[10]    ;            /* offset = 0x       */
} LCD_TypeDef;
...
typedef struct {
  ...
  __IO uint32_t HFCONST    ;            /* offset = 0x20        */
  __IO uint32_t D2FP0      ;            /* offset = 0x24        */
  __IO uint32_t D2FP1      ;            /* offset = 0x28        */
} NVM_TypeDef;
...
#ifdef NOREMAP
#define FLASH_MEMORY_BASE           ((uint32_t )0x18000000             )
#else
#define FLASH_MEMORY_BASE           ((uint32_t )0x0                    )
#endif

#define EEPROM_MEMORY_BASE          ((uint32_t )0x08000000             )
#define SRAM_BASE                   ((uint32_t )0x10000000             )
...
#ifdef FPGA_SIM
#ifdef RA9103AM0
#define FLASH_BASE                  (FLASH_MEMORY_BASE + 0xc0000          )
#define EEPROM_BASE                 (EEPROM_MEMORY_BASE + 0x20000         )
#endif
#ifdef RA9103A0
#define FLASH_BASE                  (FLASH_MEMORY_BASE + 0x00800000       )
#define EEPROM_BASE                 (EEPROM_MEMORY_BASE + 0x00800000      )
#endif
#endif
#ifdef RTL_SIM
#ifdef RA9103AM0
#define FLASH_BASE                  (FLASH_MEMORY_BASE + 0x30000          )
#define EEPROM_BASE                 (EEPROM_MEMORY_BASE + 0x8000          )
#endif
#ifdef RA9103A0
#define FLASH_BASE                  (FLASH_MEMORY_BASE + 0x00800000       )
#define EEPROM_BASE                 (EEPROM_MEMORY_BASE + 0x00800000      )
...
#define OSC_CTRL_PS   0xA5230000
#define SYS_MODE_PS   0xA5560000
#define SYS_PD_PS     0xA5170000
#define ADC_CTRL_PS   0xA5540000
#define ANA_CTRL_PS   0xA5780000
#define SYS_RST_PS    0xA5260000
#define SYS_CTRL_PS   0xA5570000
#define MOD0_EN_PS    0xA5890000
#define MOD1_EN_PS    0xA5800000
#define INTC_EN_PS    0xA5430000
#define KBI_EN_PS     0xA57A0000
#define SYS_PS_PS     0x82
#define TEST_CTRL_PS  0xA5730000
#define DEBUG_CTRL_PS 0xA50C0000
#define ANA_ADC_PS    0xA5770000
#define ANA_CLK_PS    0xA5270000
#define ANA_LDO_PS    0xA5580000
#define ANA_BGR_PS    0xA5280000
