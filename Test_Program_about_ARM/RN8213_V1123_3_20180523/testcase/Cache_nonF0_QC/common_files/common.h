...
typedef enum {MOD_SYS_TC = 0, MOD_CP = 3, MOD_TC0 = 4, MOD_TC1 = 5, MOD_UART4 = 6, MOD_UART5 = 7, MOD_UART0 = 8, \
	             MOD_UART1 = 9, MOD_UART2 = 10, MOD_UART3 = 11, MOD_IR = 12,MOD_7816 = 13, MOD_IIC = 14, MOD_SPI = 15,\
               MOD_GPIO = 37, MOD_LCD = 38, MOD_WDT = 41, MOD_RTC = 42, MOD_CMPLVD = 43} MOD_CLK_ID;
